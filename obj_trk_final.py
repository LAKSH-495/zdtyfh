...
video = cv2.VideoCapture("C:\\Users\\Admin\\Desktop\\DESKTOP\\LAKSH\\WHITEHAT JR\\PYTHON CODES\\P-107\\project-C107-template-main\\footvolleyball.mp4")
#load tracker 
...
while True:
    ...
    if success:
        ...
        cv2.putText(img,"lost",(75,90),cv2.FONT_HERSHEY_SIMPLEX,0.7,(255,0,255),2)    
    goal_track(img,bbox)
